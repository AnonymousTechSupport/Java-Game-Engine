...
/**
 * Handles the creation and management of the game window This class is
 * responsible for initializing GLFW, creating a borderless fullscreen window,
 * and managing the rendering loop It also provides methods for polling events
 * and swapping buffers The window is designed to cover the entire primary
 * monitor without any decorations (title bar, borders)
 */
public class WindowHandler {
  ...
  /**
   * Poll for window events. This should be called regularly (e.g., once per
   * frame) to ensure the window remains responsive. This will process events
   * such as input, window close requests, and other interactions.
   */
  ...
  /**
   * Swap the window's buffers. This should be called at the end of each frame
