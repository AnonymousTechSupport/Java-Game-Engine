...
/**
 * Central state manager controlling PLAYING / EDITOR / PAUSED.
...
public class StateManager {
    ...
    public synchronized boolean isPlaying() { return state == EngineState.PLAYING; }
    ...
    public synchronized void setState(EngineState next) {
        ...
        onEnter(next);
        for (StateListener l : listeners) l.onStateChanged(prev, next);
    }
